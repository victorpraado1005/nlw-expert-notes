  ...
  return (
    <Dialog.Root open={isOpenDialog} onOpenChange={setIsOpenDialog}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed overflow-hidden inset-auto left-1/2 top-2/4 md:top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[90vh] md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
          ...
          <form className='flex-1 flex flex-col'>
            ...
            {isRecording ? (
              ...
              <button
                ...
                disabled={!content}
                className='w-full disabled:bg-slate-400 disabled:text-slate-500 disabled:cursor-not-allowed bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500'
              >
                Salvar nota
              </button>
            )}
