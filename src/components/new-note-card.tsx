  ...
  return (
    <Dialog.Root open={isOpenDialog} onOpenChange={setIsOpenDialog}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed overflow-hidden inset-auto left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[70vh] md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
